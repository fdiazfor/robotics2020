...
/** \mainpage RoboComp::gotoxy3
 *
 * \section intro_sec Introduction
 *
 * The gotoxy3 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/gotoxy3 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class gotoxy3 : public RoboComp::Application
{
public:
	gotoxy3 (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::gotoxy3::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::gotoxy3 app(prefix, startup_check_flag);
