...
/** \mainpage RoboComp::gotoxy2
 *
 * \section intro_sec Introduction
 *
 * The gotoxy2 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/gotoxy2 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class gotoxy2 : public RoboComp::Application
{
public:
	gotoxy2 (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::gotoxy2::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::gotoxy2 app(prefix, startup_check_flag);
